...
terragrunt = {
  ...
  terraform {
    source = "git::git@github.com:teamdigitale/dpt-services-infra-tf-modules.git//azurerm_aks_cluster"
  }
...
azurerm_kubernetes_cluster_agent_pool_profile_min_count       = 1
azurerm_kubernetes_cluster_agent_pool_profile_max_count       = 3
azurerm_kubernetes_cluster_agent_pool_profile_vm_size         = "Standard_D4s_v3"
